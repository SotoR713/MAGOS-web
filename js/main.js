...
import { Agua,Fuego, Tierra,Planta } from "./datos/ListaElementos.js";
...
const heroe = new Jugador(idJugador, "SotoR713", Fuego, 20, 20, 10, 10, 10, 10);

const generador = new Generador(idJugador);
const rival = crearRival(generador.aleatorio(), 8);
